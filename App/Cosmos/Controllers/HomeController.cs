...
namespace Cosmos.Controllers
{
    public class HomeController : Controller
    {
        ...
        List<List<string>> depthFirst = new List<List<string>> { }; //Result generated by search for routes from place to place, ex. Jupiter -> Mars (if no direct flights) Jupiter -> Earth -> Venus -> Mars
        ...
        {
            foreach (var path in depthFirst) // for different paths from place to place, find relevant flight chains, max 50 for each
            {
        ...
        public void depthFind(string from, string to, List<string> temp) // generating paths
        {
            ...
            foreach (var destination in paths[temp[temp.Count - 1]]) // look at all possible routes from starting point
            {
