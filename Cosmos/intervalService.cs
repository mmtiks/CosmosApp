...
//    {
//        CosmosDataContext context;
//        IServiceScope scope;

//        public IntervalService(IHost host)
//        {
//            AppContext.SetSwitch("Npgsql.EnableLegacyTimestampBehavior", true);
//            AppContext.SetSwitch("Npgsql.DisableDateTimeInfinityConversions", true);
//            using var scope = host.Services.CreateScope();
//            this.context = scope.ServiceProvider.GetRequiredService<CosmosDataContext>();
//            context.Database.EnsureCreated();
//            Thread printer = new Thread(new ThreadStart(InvokeMethod));
//            printer.Start();
//        }

//        public void Starter( IHost host)
//        {
...
//        private void GetFlights(string response)
//        {
...
//            Console.WriteLine(context.Pricelist.FirstOrDefault().id);
...
//        private void RemoveLastPriceList(CosmosDataContext context)
//        {
